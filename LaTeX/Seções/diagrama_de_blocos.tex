...
As conexões do sensor DHT11 com a ESP32 são: VDD no 3.3V, DATA no pino 15 e GND no GND. Já as conexões dos LEDs com a ESP32 são: LED D1 no pino 32, LED D2 no pino 26, LED D3 no pino 12 nos ânodos dos LEDs. Nos cátodos dos LEDs, todos estão interconectados e se ligam na trilha que vai para o GND da ESP32.

\begin{figure}[H]
   \centering
   \includegraphics[width=0.7\textwidth]{imagens/esp32esquematico.png} 
