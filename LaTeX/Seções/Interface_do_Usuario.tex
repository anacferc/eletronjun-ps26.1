...
% colocar imagem do prototipo de baixa fidelidade aqui
...
A interface também apresenta quatro blocos: um para registrar as medições de temperatura, exibida em graus Celsius, outro para representar a umidade relativa do ar, exibida em porcentagem, outro para descrever o índice de calor, que realiza uma média do registro das temperaturas, e o último que se trata de um gráfico que mostra a variação das temperaturas e ao lado existe uma parte de alertas, onde o sistema alerta quando a temperatura passa de 28°C. 
